...
<img style="display: block; margin-left: auto; margin-right: auto; width: 30%" alt="The tool's left options" src="./doc/img/tool_ui_left_opt.png"/>

The first one contains various tool options, including those that influence the symbolic regression.

<img style="display: block; margin-left: auto; margin-right: auto; width: 30%" alt="The tool's left grammar" src="./doc/img/tool_ui_left_gr.png"/>
